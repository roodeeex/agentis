    ...
    <div className="min-h-screen bg-bg-primary">
      ...
      <section className="h-screen flex items-center justify-center px-4 pt-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-32 left-32 w-1.5 h-1.5 bg-orange-600 rounded-full animate-bounce"></div>
          <div className="absolute bottom-40 right-20 w-1 h-1 bg-orange-500 rounded-full animate-pulse"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center">
            ...
            >
              <div className="bg-gradient-to-r from-orange-100 to-purple-100 px-6 py-3 rounded-full flex items-center space-x-3">
            ...
            >
              <motion.button
                className="bg-orange-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-orange-700 transition-colors flex items-center space-x-2"
              ...
              <motion.button
                className="flex items-center space-x-2 text-text-secondary hover:text-orange-600 transition-colors bg-white border-2 border-border-primary px-8 py-4 rounded-full font-semibold text-lg hover:border-orange-200"
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-xl border border-border-primary">
                <div className="text-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center">
            ...
            {[
              ...
              >
                ...
                <div className="relative mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-purple-500 rounded-2xl mx-auto flex items-center justify-center">
      ...
      {/* Call to Action */}
      <section className="py-20 px-4 bg-gradient-to-r from-orange-600 via-purple-600 to-blue-600 text-white">
